...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Text = L"Pozdrav svima, ovo je aplikacija pomocu koje možete otvoriti željenu jpg sliku te"
				L" je zumirat i odzumirat. Takodjer možete listat sve slike koje su unutar foldera"
				L" odabrane slike. :)";
			// 
			// About
			// 
